...
local reinstallUrl = "https://raw.githubusercontent.com/Kingifyfrmdao/98KA/main/NewMainScript.lua"
...
if not isfolder(keepFullPath) then
    print("warning: '" .. keepFullPath .. "' missing - everything about to get deleted")
end
