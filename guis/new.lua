...
scarcitybanner.Text = 'Join 98KAV4 server to report any bugs, suggestions or buy prem, click discord icon :D'
...
general:CreateButton({
	...
	mainapi.Save = function() end
		...
		if shared.VapeDeveloper then
			...
			loadstring(game:HttpGet('https://raw.githubusercontent.com/Kingifyfrmdao/98KA/'..readfile('newvape/profiles/commit.txt')..'/loader.lua', true))()
		end
	end,
